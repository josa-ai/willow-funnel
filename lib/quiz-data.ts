...
export const quizQuestions: QuizQuestion[] = [
  {
    ...
    options: [
      { text: "Yes. Everyone can articulate it.", score: 4 },
      { text: "Mostly. Some interpretations vary.", score: 3 },
  ...
  },
  {
    ...
    options: [
      { text: "Within the last 3 months", score: 4 },
      { text: "Within the last 6 months", score: 3 },
  ...
  },
  {
    ...
    options: [
      { text: "Crystal clear. Everyone sees how their work connects.", score: 4 },
      { text: "Mostly clear, but some gaps exist.", score: 3 },
  ...
  },
  {
    ...
    options: [
      { text: "Highly aligned. We coordinate well.", score: 4 },
      { text: "Somewhat aligned, but silos exist.", score: 3 },
  ...
  },
  {
    ...
    options: [
      { text: "Deeply connected. It fuels them.", score: 4 },
      { text: "Somewhat connected, but the day-to-day clouds it.", score: 3 },
  ...
  },
  {
    ...
    options: [
      { text: "Purpose-driven and collaborative", score: 4 },
  ...
  },
  {
    ...
    options: [
      { text: "Rarely. We protect strategic focus.", score: 4 },
  ...
  },
  {
    ...
    options: [
      { text: "Aligned and strategic", score: 4 },
      { text: "Mostly coordinated with occasional gaps", score: 3 },
  ...
  },
  {
    ...
    options: [
      { text: "Yes, we have capacity and budget.", score: 4 },
      { text: "We could create capacity for the right solution.", score: 3 },
  ...
  },
  {
    ...
    options: [
      { text: "Executive Director / CEO", score: 4 },
      { text: "Senior Leadership / C-Suite", score: 4 },
      { text: "Board Leadership", score: 3 },
